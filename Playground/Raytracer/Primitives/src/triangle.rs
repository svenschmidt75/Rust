...
pub struct Triangle {
	v1: Vertex4f::Vertex4f,
	v2: Vertex4f::Vertex4f,
	v3: Vertex4f::Vertex4f,

	normal: Vector4f::Vector4f,
}

impl Triangle {
	pub fn new(v1: Vertex4f::Vertex4f, v2: Vertex4f::Vertex4f, v3: Vertex4f::Vertex4f) -> Self {
...
mod tests {
	...
	fn almost_equal(lhs: Vector4f::Vector4f, rhs: Vector4f::Vector4f, tolerance: f64) -> bool {
		return
	...
	fn test_normal_for_right_hand_side_triangle() {
		let v1 = Vertex4f::Vertex4f::new(0.0, 0.0, 0.0, 1.0);
		let v2 = Vertex4f::Vertex4f::new(1.0, 0.0, 0.0, 1.0);
		let v3 = Vertex4f::Vertex4f::new(1.0, 1.0, 0.0, 1.0);
		let triangle = Triangle::new(v1, v2, v3);
		let exptected_normal = Vector4f::Vector4f::new(0.0, 0.0, 1.0, 1.0);
